...
namespace OrchardCore.Themes.IvethsBlogTheme
{
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                .DefineScript("IvethsBlogTheme-vendor-jQuery")
                .SetUrl("~/IvethsBlogTheme/vendor/jquery/jquery.min.js", "~/IvethsBlogTheme/vendor/jquery/jquery.js")
            ...
            manifest
                .DefineScript("IvethsBlogTheme-vendor-jQuery.slim")
                .SetUrl("~/IvethsBlogTheme/vendor/jquery/jquery.slim.min.js", "~/IvethsBlogTheme/vendor/jquery/jquery.slim.js")
            ...
            manifest
                .DefineScript("IvethsBlogTheme-vendor-bootstrap")
                .SetDependencies("IvethsBlogTheme-vendor-jQuery")
                .SetUrl("~/IvethsBlogTheme/vendor/bootstrap/js/bootstrap.min.js", "~/IvethsBlogTheme/vendor/bootstrap/js/bootstrap.js")
            ...
            manifest
                .DefineScript("IvethsBlogTheme-vendor-bootstrap-bundle")
                .SetDependencies("IvethsBlogTheme-vendor-jQuery")
                .SetUrl("~/IvethsBlogTheme/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/IvethsBlogTheme/vendor/bootstrap/js/bootstrap.bundle.js")
            ...
            manifest
                .DefineStyle("IvethsBlogTheme-vendor-bootstrap")
                .SetUrl("~/IvethsBlogTheme/vendor/bootstrap/css/bootstrap.min.css", "~/IvethsBlogTheme/vendor/bootstrap/css/bootstrap.css")
            ...
            manifest
                .DefineStyle("IvethsBlogTheme-bootstrap-oc")
                .SetUrl("~/IvethsBlogTheme/css/bootstrap-oc.min.css", "~/IvethsBlogTheme/css/bootstrap-oc.css")
                .SetVersion("1.0.0");

            manifest
                .DefineStyle("IvethsBlogTheme-vendor-font-awesome")
                .SetUrl("~/IvethsBlogTheme/vendor/fontawesome-free/css/all.min.css", "~/IvethsBlogTheme/vendor/fontawesome-free/css/all.css")
            ...
            manifest
                .DefineScript("IvethsBlogTheme-vendor-font-awesome")
